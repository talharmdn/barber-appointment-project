...
$sql ="UPDATE randevular ".
      "SET ad='$ad',soyad='$soyad',cep_telefon='$cep_telefon',tarih='$tarih'. '$saat' ".
            ...
            <div class="card bg-light">
                ...
                <?php
                    ...
                    if(!$cevap){
                        ...
                        echo "<h4 class='text-center'>Kayıt Güncellendi.</h4>";
                        echo " <br><p class='text-center'>Güncellenmiş listeyi görmek için<a href='listele.php'> tıklayınız</a></p>\n";
                    }
                ?>
                </article>
            </div>
