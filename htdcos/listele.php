...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
   ...
   <ul class="nav nav-pills ">
      ...
      <li class="nav-item">
      <a class="btn btn-danger" href="listele.php">Randevuları Listele</a>
      </li>
   </ul>
...
<div class="card bg-light">
      ...
      <?php
        ...
        echo "<tr align='center'><th scope=col'>Randevu ID</th><th scope=col'>Adı</th><th scope=col'>Soyadı</th><th scope=col'>Cep Telefonu</th><th scope=col'>Tarih</th><th scope=col'>Saat</th></tr>";
        ...
        ?>
        <hr>
        <p align="center">Yeni randevu oluşturmak için <a href='_randevu_olustur.php'> tıklayınız</a></p>
        <hr>
      </article>
   </div>
    <!-- anasayfa bitişi -->
