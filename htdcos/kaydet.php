...
$sql = "INSERT INTO randevular ".
       "(ad,soyad,cep_telefon,tarih,saat) ".
       "VALUES ( '$ad','$soyad', '$cep_telefon', '$tarih', '$saat')";
        ...
        <div class="container">
            ...
            <div class="card bg-light">
                ...
                <?php
                    ...
                    {
                        echo "<h5 class='text-center'>Randevunuz başarıyla oluşturuldu, </h5><p class='text-center'>Randevularınızı görmek için";
                        echo " <a href='listele.php'> tıklayınız</a></p>\n";
                    }
                ?>
                </article>
            </div>
